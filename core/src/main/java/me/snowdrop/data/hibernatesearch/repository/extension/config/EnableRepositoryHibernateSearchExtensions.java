...
@Documented
@Inherited
@Import(RepositoryHibernateSearchExtensionsRegistrar.class)
public @interface EnableRepositoryHibernateSearchExtensions {
  ...
  String extendedRepositoryImplementationPostfix() default "Impl";
